        ...
        <div class="card">
          ...
          <div class="card-body">
            <table id="example1" class="table table-bordered table-striped">
              <button type="button" class="btn btn-primary" onclick="window.location.href='<?= site_url();?>/Submenu/add_data';">Tambah</button>
              <br>
                <br>
              <thead>
              <tr>
              ...
              <tbody>
                <?php foreach($sub_menu as $row_sub_menu){?>
                    <tr>
                        ...
                        <td style="text-align:center;"><a style="color:white;" type="button" href="<?= site_url('Submenu/edit_data/').$row_sub_menu->id_sub_menu ;?>" class="btn btn-info" > Ubah</a</td>
    ...
    <div class="modal fade" id="delete<?= $row_sub_menu->id_sub_menu?>">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form method="post" action="<?= site_url('Submenu/delete_data');?>">
