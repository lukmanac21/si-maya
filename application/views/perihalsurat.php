        ...
        <div class="card">
          ...
          <div class="card-body">
            <table id="example1" class="table table-bordered table-striped">
              <button type="button" class="btn btn-primary" onclick="window.location.href='<?= site_url();?>/Perihalsurat/add_data';">Tambah</button>
              <br>
                <br>
              <thead>
              <tr>
              ...
              <tbody>
                <?php foreach($perihal as $row_perihal){?>
                    <tr>
                        <td><?= $row_perihal->kode_perihal;?></td>
                        <td><?= $row_perihal->nama_perihal;?></td>
                        <td style="text-align:center;"><a style="color:white;" type="button" href="<?= site_url('Perihalsurat/edit_data/').$row_perihal->id_perihal ;?>" class="btn btn-info" > Ubah</a</td>
    ...
    <div class="modal fade" id="delete<?= $row_perihal->id_perihal?>">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form method="post" action="<?= site_url('Perihalsurat/delete_data');?>">
