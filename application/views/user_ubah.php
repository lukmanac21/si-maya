    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card-header">
            <h3 class="card-title">Ubah Data Master User</h3>
          </div>
            <div class="card-body">
                ...
                <form class="form-horizontal" user="form" action="<?= site_url('User/save_data');?>" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <select class="form-control select2" name="id_role" style="width: 100%;">
                                ...
                                <option value="<?= $row_role->id_role;?>"<?php if ($row_role->id_role == $row_user->id_role) echo "selected = 'selected'"?>><?= $row_role->nama_role;?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <input type="email" class="form-control" name="email_user" placeholder="Email User" required unique="true">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-1 col-form-label">Password</label>
                        <div class="col-sm-10">
                        <input type="password" class="form-control" name="password_user" placeholder="Password User" required>
                        </div>
                    </div>
                    </div>
                    <!-- /.card-body -->
