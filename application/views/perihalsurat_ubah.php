      ...
      <div class="container-fluid">
        ...
        <div class="card-header">
            ...
            <?php foreach($perihal as $row_perihal){?>
                <form class="form-horizontal" role="form" action="<?= site_url('Perihalsurat/update_data');?>" method="post">
                    <div class="card-body">
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Kode perihal</label>
                        <div class="col-sm-10">
                        <input type="text" class="form-control" name="kode_perihal" placeholder="Kode perihal" value="<?= $row_perihal->kode_perihal;?>" required>
